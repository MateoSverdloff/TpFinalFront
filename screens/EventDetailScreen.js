...
const EventDetailScreen = ({ route }) => {
        ...
        const fetchEvent = async () => {
            try {
                ...
                if (data.success) {
                    ...
                    await handleParticipants(); // Llama a la función para obtener participantes
                } else {
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Siempre mostrar participantes */}
            <View>
                <Text style={styles.participantHeader}>Participantes:</Text>
                <FlatList
                    data={participants}
                    keyExtractor={(item) => item.username} // Cambia según tu clave única
                    renderItem={({ item }) => (
